...
//    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().configurationSource(request -> {
                ...
                .disable()
                .authorizeRequests()
                .antMatchers("/api/customers/login","/api/products/search","/api/categories","/api/brand","/api/customers/register","/api/products/get/*","/api/products/get-reviews","/api/products/filter/*","/api/chat/*").permitAll()// Cho phép tất cả mọi người truy cập vào địa chỉ này
